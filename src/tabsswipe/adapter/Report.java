...
public class Report extends Fragment  implements View.OnClickListener {
	...
	// Activity request codes
		...
		private Button take_pic, signin;
		private int RESULT_OK=-1;
		private int RESULT_CANCELED=0;
		private EditText name, location,phone,comment,email;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgPreview = (ImageView)rootView. findViewById(R.id.imgPrevie);		
		take_pic = (Button)rootView. findViewById(R.id.take_pic);
		...
		email = (EditText)rootView. findViewById(R.id.email_id);
